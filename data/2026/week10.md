...
curator: m
published: true
exactDate: 2026-03-09
links:
  paragraph: https://paragraph.com/0x0f1f3daf416b74db3de55eb4d7513a80f4841073
---


![alt text](https://github.com/web3privacy/news/blob/main/web/public/img/2026-10.png?raw=true)
...
### Tool of the week
- [WalletBeat - dashboard for the Ethereum wallets](https://walletbeat.eth.limo/)
---
...
- [Some LLMs can now unmask your autonomous identity on the Internet](https://arstechnica.com/security/2026/03/llms-can-unmask-pseudonymous-users-at-scale-with-surprising-accuracy/)
---
### Knowledge
- [Paralelni Polis in Prague, Czech republic has closed down](https://kryptomagazin.cz/en/paralelni-polis-end-forever-2026)
- [...but they are continuing for events which you can check here](dark.events)
...
- [Nico Consigny talks about Kohaku during Trustless Conference](https://www.youtube.com/watch?v=sU3Q5aLwHSY)
